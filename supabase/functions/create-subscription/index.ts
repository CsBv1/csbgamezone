...
const SUBSCRIPTION_TIERS = {
  tier1: {
    priceId: "price_1SwHgzRuNuuh5KeEDBAMqiud",
    bulls: 1,
    buff: 10,
    price: 5
  },
  tier2: {
    priceId: "price_1SwHhPRuNuuh5KeEvSbQlNtU",
    bulls: 4,
    buff: 40,
    price: 15
  },
  tier3: {
    priceId: "price_1SwHhfRuNuuh5KeEACT2kxEj",
    bulls: 10,
    buff: 100,
    price: 30
  }
...
serve(async (req) => {
  ...
  try {
    ...
    if (!authHeader) {
      throw new Error("No authorization header provided - please log in first");
    }
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "subscription",
      success_url: `${origin}/games/bull-world?subscription=success&tier=${tier}`,
