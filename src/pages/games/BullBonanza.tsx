...
const BullBonanza = () => {
  ...
  const playGame = () => {
    ...
    setTimeout(() => {
      const bonanzaLevel = Math.floor(Math.random() * 5) + 1;
      const diamonds = bonanzaLevel * 10;
      toast({ 
        title: `✨ Bonanza x${bonanzaLevel}!`, 
        description: `Amazing bonanza! Won ${diamonds} diamonds!` 
      });
      setPlaying(false);
    }, 1300);
  };
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <Card className="mt-6 p-8 bg-card/95 backdrop-blur-sm">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">Experience the bonanza!</p>
            ...
            >
              {playing ? "Spinning..." : "Play Bonanza (15 Credits)"}
            </Button>
          </div>
        </Card>
      </div>
