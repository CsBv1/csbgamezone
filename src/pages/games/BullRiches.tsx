...
const BullRiches = () => {
  ...
  const playGame = () => {
    ...
    setTimeout(() => {
      const richLevel = Math.floor(Math.random() * 4) + 1;
      const diamonds = richLevel * 15;
      toast({ 
        title: `💰 Riches Level ${richLevel}!`, 
        description: `Struck it rich! ${diamonds} diamonds!` 
      });
      setPlaying(false);
    }, 1200);
  };
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <Card className="mt-6 p-8 bg-card/95 backdrop-blur-sm">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">Strike it rich with the bulls!</p>
            ...
            >
              {playing ? "Striking..." : "Seek Riches (20 Credits)"}
            </Button>
          </div>
        </Card>
      </div>
