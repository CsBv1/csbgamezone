...
const MilkTheBull = () => {
  ...
  const sellMilk = async () => {
    if (milk > 0) {
      const diamondsEarned = milk * 2;
      const creditsEarned = Math.floor(milk / 5);
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 bg-accent/10">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                <div className="text-2xl font-bold text-accent">💎 {milk * 2}</div>
                <div className="text-sm text-muted-foreground">Diamonds (1 milk = 2 💎)</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-primary">💰 {Math.floor(milk / 5)}</div>
                <div className="text-sm text-muted-foreground">Credits (5 milk = 1 💰)</div>
              </div>
            </div>
          </Card>
