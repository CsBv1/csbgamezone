...
const BullsParadise = () => {
  ...
  const playGame = () => {
    ...
    setTimeout(() => {
      ...
      if (win) {
        const diamonds = Math.floor(Math.random() * 10) + 5;
        toast({ 
          title: "🐂 Bull Win!", 
          description: `You earned ${diamonds} diamonds!` 
        });
      } else {
        toast({ title: "Try again!", description: "Better luck next time!" });
      }
      setPlaying(false);
    }, 1000);
  };
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <Card className="mt-6 p-8 bg-card/95 backdrop-blur-sm">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">Enter paradise and win diamonds!</p>
            ...
            >
              {playing ? "Playing..." : "Play (10 Credits)"}
            </Button>
          </div>
        </Card>
      </div>
